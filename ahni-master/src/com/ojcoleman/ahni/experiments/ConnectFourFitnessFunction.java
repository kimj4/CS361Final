...
/**
 * Fitness function for the connect four
 * This is a modified version of ObjectRecognitionFitnessFunction2.java
 * For an individual
 *  Set up games and play every individual (for now)
 * In order to play games
 *  get the grid representation of the game
 *  make moves between the individual
 *
 * MyConnectFour will be an object that contains the board. Should be able to call functions to make moves
 *
 */
public class ConnectFourFitnessFunction extends HyperNEATFitnessFunction {
    private static Logger logger = Logger.getLogger(ConnectFourFitnessFunction.class);
...
//    }
    ...
    public double evaluate(List<Chromosome> genotypes) {
        System.out.println("\n========================================================");
        System.out.println("======== evaluate in ConnectFourFitnessFunction ========");
        System.out.println("========================================================\n");
        return 4;
    }
